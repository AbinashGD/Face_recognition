...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'abitheking14@gmail.com' ")
...
def TrackImages():
        ...
        for i , lines in enumerate(reader1):
            if i > 0 and len(lines) >= 7:
                ...
                if record_id not in added_to_gui:
                    ...
                    tv.insert("", 0, text=record_id, values=(str(lines[2]), str(lines[4]), str(lines[6])))
                else:
    ...
    sql = "INSERT INTO attendance (id, username, date, time) VALUES (%s,%s,%s,%s)"
...
bg_image = Image.open(r"C:\Users\abina\PycharmProjects\face\image\ig.jpg")
...
frame1 = tk.Frame(window, bg="cyan")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="cyan")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Face Recognition Based Attendance System" ,fg="black",bg="white" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="blue",bg="black" ,width=55 ,height=1,font=('times', 22, ' bold '))
...
head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="black",bg="orange" ,font=('times', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="black",bg="orange" ,font=('times', 17, ' bold ') )
head1.place(x=0,y=0)

lbl = tk.Label(frame2, text="Enter ID",width=20  ,height=1  ,fg="black"  ,bg="cyan" ,font=('times', 17, ' bold ') )
lbl.place(x=80, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Name",width=20  ,fg="black"  ,bg="cyan" ,font=('times', 17, ' bold '))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2,width=32 ,fg="black" ,font=('times', 15, ' bold ')  )
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile" ,bg="cyan" ,fg="black"  ,width=39 ,height=1, activebackground = "yellow" ,font=('times', 16, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="cyan" ,fg="black"  ,width=39,height=1, activebackground = "yellow" ,font=('times', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="Attendance",width=20  ,fg="black"  ,bg="cyan"  ,height=1 ,font=('times', 18, ' bold '))
...
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages  ,fg="black"  ,bg="green"  ,width=38  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
