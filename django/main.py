...
def TrackImages():
    ...
    cursor = mydb.cursor()
    row = (attendance[0], attendance[2], attendance[4], attendance[6])
...
message3 = tk.Label(window, text="Face Recognition Based Attendance System" ,fg="black",bg="lavender" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="blue",bg="lavender" ,width=55 ,height=1,font=('times', 24, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="blue",bg="lavender" ,width=55 ,height=1,font=('times', 24, ' bold '))
...
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages  ,fg="black"  ,bg="yellow"  ,width=38  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
